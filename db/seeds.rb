...
#   Character.create(name: 'Luke', movie: movies.first)
  ...
  Baby.create!(first_name: "Katie", date_of_birth: "01/02/2010", category: "calm", bio:"Nice baby super friendly", price: "30", user: user1, remote_photo_url: "https://source.unsplash.com/random?baby?#{rand}")
  Baby.create!(first_name: "Martin", date_of_birth: "10/03/2008", category: "geek", bio:"Nice baby super friendly", price: "15", user: user1, remote_photo_url: "https://source.unsplash.com/random?baby?#{rand}")
  Baby.create!(first_name: "Stephane", date_of_birth: "26/02/2015", category: "Jedi Master", bio:"Nice baby super friendly", price: "150", user: user1, remote_photo_url: "https://source.unsplash.com/random?baby?#{rand}")
