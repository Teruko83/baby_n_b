...
#   Character.create(name: 'Luke', movie: movies.first)
  ...
  Baby.create!(first_name: "Johnny", date_of_birth: "01/02/2010", category: "calm", bio:"Nice baby super friendly", price: "15", user: user1, remote_photo_url: "https://source.unsplash.com/random?baby?#{rand}")
  ...
  Baby.create!(first_name: "Stephane", date_of_birth: "26/02/2015", category: "calm", bio:"Nice baby super friendly", price: "15", user: user1, remote_photo_url: "https://source.unsplash.com/random?baby?#{rand}")
  Baby.create!(first_name: "MG", date_of_birth: "01/05/2018", category: "calm", bio:"Nice baby super friendly", price: "15", user: user2, remote_photo_url: "https://source.unsplash.com/random?baby?#{rand}")
  ...
  Baby.create!(first_name: "Adolph", date_of_birth: "01/02/2010", category: "bossy", bio:"Nice baby super friendly", price: "15", user: user2, remote_photo_url: "https://source.unsplash.com/random?baby?#{rand}")
  ...
  Baby.create!(first_name: "Justin", date_of_birth: "01/02/2010", category: "calm", bio:"Nice baby super friendly", price: "15", user: user3, remote_photo_url: "https://source.unsplash.com/random?baby?#{rand}")
